        ...
        <div className="grid grid-cols-12 gap-6 w-full my-8 text-lg relative">
          <div className="col-span-12 lg:col-span-5 relative bg-[#f9f9f9] p-4 rounded-lg shadow-md ">
            ...
            <div className="space-y-8 text-[#868686]">
              ...
              <div>
                <strong className="text-[#3C3B6E]">Quest:</strong> Complete a
                set number of trips within a specific time frame.
              </div>
              <div>
                <strong className="text-[#3C3B6E]">
              ...
              <div>
                <strong className="text-[#3C3B6E]">Surge Based:</strong> Drive
              ...
              <div>
                ...
                Drivers ignore trips while heading to the surge zone, as the
              ...
              <div>
                <strong className="text-[#3C3B6E]">Time Based:</strong> Earn a
              ...
              <div className="">
                ...
                <span className="text-[#3C3B6E] mt-4 block">
          ...
          <div className="col-span-12 lg:col-span-5 relative bg-[#f9f9f9] p-4 rounded-lg shadow-md">
            ...
            <div className="space-y-8 text-[#868686]">
              ...
              <div>
                <strong className="text-[#3C3B6E]">
                  Riders Get Rewarded by Drivers:
                </strong>
