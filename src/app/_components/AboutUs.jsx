...
const AboutUs = () => {
  return (
    <section
      id="about"
      className=" w-full md:px-0 px-4     text-primary  h-auto "
    >
        ...
        <div className="my-8 flex justify-center lg:justify-start relative">
          ...
          <div className="absolute left-[15px] top-[-45px] rounded-full md:w-40 md:h-40 h-32 w-32 bg-white shadow-md flex items-center justify-center">
            <div className="text-center space-y-3 ">
              <h1 className="md:text-5xl text-4xl text-tertiary font-extrabold">3M</h1>
      ...
      <div className="lg:w-1/2 text-center lg:text-left">
          <div className="mb-6 md:mx-12 mx-0">
            ...
            <p className="text-xl leading-relaxed mb-4">
              <FaRocket className="inline mr-2 text-2xl text-tertiary" />
            ...
            <p className="text-xl leading-relaxed mb-4 ">
              <FaExclamationCircle className="inline mr-2 text-2xl text-tertiary" />
            ...
            <p className="text-xl leading-relaxed mb-4">
              <FaUsersCog className="inline mr-2 text-2xl text-tertiary" />
            ...
            <p className="text-xl leading-relaxed mb-4">
              <GiMoneyStack className="inline mr-2 text-2xl text-tertiary" />
