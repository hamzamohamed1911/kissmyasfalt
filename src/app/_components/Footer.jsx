  ...
  return (
    <footer className="bg-[#2a2a2a]   dark:bg-gray-900 font-urban">
     ...
     <span className="block text-sm text-white sm:text-center dark:text-gray-400">
        ...
        <Link className="flex items-center justify-center duration-300 transform hover:scale-110" href="/">
            <Image alt="kiss my asfalt" className="w-auto h-24"  priority src={Logo}/>
        </Link>
       
     <div className="flex flex-row gap-6 md:gap-4 justify-center lg:justify-start items-center lg:items-start md:my-6 my-4">
            <button
